    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 bg-white dark:bg-dark-950">
        <div className="w-full max-w-md space-y-6 sm:space-y-8 animate-fade-in">
          ...
          {successMsg && (
            <div className="bg-success-50 dark:bg-success-950/50 border border-success-200 dark:border-success-800 rounded-lg p-4 flex items-start gap-3">
              <svg className="w-5 h-5 text-success-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
              <p className="text-sm text-success-700 dark:text-success-400">{successMsg}</p>
            </div>
          )}
